...
class WellBeingHealthAtWork extends Component {
    constructor(props) {
        super(props);
        this.state = {  }
    }
    ...
    return (
        ...
        <h1 styles={{textAlign:'centre'}}>Health At Work</h1>
...
export default connect(mapStateToProps, actions)(WellBeingHealthAtWork);