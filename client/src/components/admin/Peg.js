...
import { addPeg } from '../../actions/pegActions';
...
class Peg extends Component {
    constructor(props) {
        ...
        this.props.addPeg(newState, this.props.history);
        ...
        return (
            ...
            <div>
                ...
                <div className="form_devider"></div>
                           ...
                           <input className="submitBtn" type="submit"  value="Add PEG Event"/>
...
export default connect(mapStateToProps, actions)(withRouter(Peg));