...
import { addGuidance } from '../../actions/guidanceActions';
...
class Guidance extends Component {
    constructor(props) {
        ...
        this.props.addGuidance(newState, this.props.history);
        ...
        return (
            ...
            <div>
                ...
                <div className="form_devider"></div>
                           ...
                           <input className="submitBtn" type="submit"  value="Submit Guidance"/>
...
export default connect(mapStateToProps, actions)(withRouter(Guidance));